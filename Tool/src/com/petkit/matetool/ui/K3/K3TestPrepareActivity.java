...
import static com.petkit.matetool.ui.K3.utils.K3Utils.FILE_CHECK_INFO_NAME;
import static com.petkit.matetool.ui.K3.utils.K3Utils.FILE_MAINTAIN_INFO_NAME;


/**
 * K3测试，测试准备，需要登录，已经缓存数据处理
 *
 * Created by Jone on 17/4/19.
 */
public class K3TestPrepareActivity extends BaseActivity {
    ...
    protected void setupViews() {
        ...
        mTester = TesterManagerUtils.getCurrentTesterForType(Globals.K3);
//        mTester = new Tester();
//        mTester.setCode("00");
...
//        mTester.setStation("1");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.logout:
                ...
                } else if(K3Utils.checkHasSnCache()) {
            ...
            case R.id.upload:
                if(mDevicesError != null) {
                    ...
                    startActivityWithData(K3ErrorListActivity.class, bundle, false);
                } else {
                    LoadDialog.show(this);
                    startUploadSn();
                }
    ...
    private void updateView () {
        if(mTester != null) {
            ...
            if(mDevicesError != null) {
                ...
                File dir = new File(K3Utils.getK3StoryDir());
    ...
    private void startTest() {
        Bundle bundle = new Bundle();
        bundle.putSerializable(K3Utils.EXTRA_K3_TESTER, mTester);
        startActivityWithData(K3StartActivity.class, bundle, false);
    }
                ...
                if(dataObj != null) {
                    try {
                        ...
                        if(Math.abs(System.currentTimeMillis() - timestamp) < 60 * 60 * 1000) {
                            ...
                            TesterManagerUtils.addTesterForType(Globals.K3, mTester);
    ...
    private void getLastSN() {
        AsyncHttpUtil.get("/api/k3/latest", new AsyncHttpRespHandler(this) {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    if(jsonObject.getInt("code") == 0 && dataObj != null && !dataObj.isNull("sn")) {
                        ...
                        K3Utils.initSnSerializableNumber(sn);
                    }
    ...
    private void loginFailed() {
        ...
        TesterManagerUtils.removeTesterForType(Globals.K3);
        mTester = null;
        updateView();
    }
    ...
    private void uploadSn(final File file) {
        ...
        if(FILE_MAINTAIN_INFO_NAME.equals(file.getName())) {
            api = "/api/k3/maintain/repair";
        } else if(FILE_CHECK_INFO_NAME.equals(file.getName())) {
            api = "/api/k3/maintain/inspect";
        } else {
            api = "/api/k3/batch";
        }
