...
public class PetkitSocketInstance implements SocketClientDelegate {
    ...
    public void startConnect(String remoteIp, int port) {
        ...
        LogcatStorageHelper.addLog("[FEEDER BIND] start connect " + remoteIp + ", port: " + port);
    ...
    public void sendString(String data) {
        ...
        LogcatStorageHelper.addLog("[FEEDER BIND] send data: " + data);
    ...
    public void onResponse(SocketClient client, @NonNull SocketResponsePacket responsePacket) {
        ...
        LogcatStorageHelper.addLog("[FEEDER BIND] onResponse: " + responsePacket.getMessage());
