...
import static com.petkit.matetool.ui.t4.utils.T4Utils.FILE_CHECK_INFO_NAME;
import static com.petkit.matetool.ui.t4.utils.T4Utils.FILE_MAINTAIN_INFO_NAME;
 ...
 */
public class T4TestPrepareActivity extends BaseActivity {
...
//        mTester.setStation("1");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.logout:
                ...
                } else if(T4Utils.checkHasSnCache()) {
            ...
            case R.id.upload:
                if(mDevicesError != null) {
                    ...
                    startActivityWithData(T4ErrorListActivity.class, bundle, false);
                } else {
                    LoadDialog.show(this);
                    startUploadSn();
                }
    ...
    private void updateView () {
        if(mTester != null) {
            ...
            if(mDevicesError != null) {
                ...
                File dir = new File(T4Utils.getT4StoryDir());
                ...
                if(dataObj != null) {
                    try {
                        ...
                        if(Math.abs(System.currentTimeMillis() - timestamp) < 60 * 60 * 1000) {
                            ...
                            TesterManagerUtils.addTesterForType(Globals.T4, mTester);
    ...
    private void getLastSN() {
        AsyncHttpUtil.get("/api/t4/latest", new AsyncHttpRespHandler(this) {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    if(jsonObject.getInt("code") == 0 && dataObj != null && !dataObj.isNull("sn")) {
                        ...
                        T4Utils.initSnSerializableNumber(sn);
                    }
    ...
    private void loginFailed() {
        ...
        TesterManagerUtils.removeTesterForType(Globals.T4);
        mTester = null;
        updateView();
    }
    ...
    private void uploadSn(final File file) {
        ...
        if(FILE_MAINTAIN_INFO_NAME.equals(file.getName())) {
            api = "/api/t4/maintain/repair";
        } else if(FILE_CHECK_INFO_NAME.equals(file.getName())) {
            api = "/api/t4/maintain/inspect";
        } else {
            api = "/api/t4/batch";
        }
