 ...
 */
public class T4StorageFileActivity extends BaseActivity {
    ...
    protected void setupViews() {
        ...
        mUploadTextView.setOnClickListener(T4StorageFileActivity.this);
    ...
    private void uploadFile(String filename) {
        ...
        AsyncHttpUtil.post("/api/T4/batch/file", params, params2, new AsyncHttpRespHandler(this, true) {
