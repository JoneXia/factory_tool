 ...
 */
public class AQRStorageFileActivity extends BaseActivity {
    ...
    protected void setupViews() {
        ...
        mUploadTextView.setOnClickListener(AQRStorageFileActivity.this);
    ...
    private void uploadFile(String filename) {
        ...
        AsyncHttpUtil.post("/api/AQR/batch/file", params, params2, new AsyncHttpRespHandler(this, true) {
