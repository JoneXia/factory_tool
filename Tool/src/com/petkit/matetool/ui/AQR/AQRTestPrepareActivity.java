...
import static com.petkit.matetool.ui.AQR.utils.AQRUtils.FILE_CHECK_INFO_NAME;
import static com.petkit.matetool.ui.AQR.utils.AQRUtils.FILE_MAINTAIN_INFO_NAME;


/**
 * AQR测试，测试准备，需要登录，已经缓存数据处理
 *
 * Created by Jone on 17/4/19.
 */
public class AQRTestPrepareActivity extends BaseActivity {
    ...
    protected void setupViews() {
        ...
        mTester = TesterManagerUtils.getCurrentTesterForType(Globals.AQR);
//        mTester = new Tester();
//        mTester.setCode("00");
...
//        mTester.setStation("1");
        ...
        mDevicesError = AQRUtils.getDevicesErrorMsg();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.logout:
                ...
                } else if(AQRUtils.checkHasSnCache()) {
            ...
            case R.id.upload:
                if(mDevicesError != null) {
                    ...
                    startActivityWithData(AQRErrorListActivity.class, bundle, false);
                } else {
                    LoadDialog.show(this);
                    startUploadSn();
                }
    ...
    private void updateView () {
        if(mTester != null) {
            ...
            if(mDevicesError != null) {
                ...
                File dir = new File(AQRUtils.getAQRStoryDir());
    ...
    private void startTest() {
        ...
        startActivityWithData(AQRStartActivity.class, bundle, false);
    }
                ...
                if(dataObj != null) {
                    try {
                        ...
                        if(Math.abs(System.currentTimeMillis() - timestamp) < 60 * 60 * 1000) {
                            ...
                            TesterManagerUtils.addTesterForType(Globals.AQR, mTester);
    ...
    private void getLastSN() {
        AsyncHttpUtil.get("/api/AQR/latest", new AsyncHttpRespHandler(this) {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    if(jsonObject.getInt("code") == 0 && dataObj != null && !dataObj.isNull("sn")) {
                        ...
                        AQRUtils.initSnSerializableNumber(sn);
                    }
    ...
    private void loginFailed() {
        ...
        TesterManagerUtils.removeTesterForType(Globals.AQR);
        mTester = null;
        updateView();
    }
    ...
    private void uploadSn(final File file) {
        ...
        if(FILE_MAINTAIN_INFO_NAME.equals(file.getName())) {
            api = "/api/AQR/maintain/repair";
        } else if(FILE_CHECK_INFO_NAME.equals(file.getName())) {
            api = "/api/AQR/maintain/inspect";
        } else {
            api = "/api/AQR/batch";
        }
                            ...
                            switch (code) {
                                ...
                                default:
                                    if(!result.isNull("data")) {
                                        ...
                                        AQRUtils.storeDuplicatedInfo(mDevicesError);
                                        file.delete();
                                        if (isLogining) {
                                            getLastSN();
                                        } else {
