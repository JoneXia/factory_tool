 ...
 */
public class T3ScanActivity extends BaseActivity implements ScanListener {
...
//        tv_scan_result.setText("结果："+rawResult.getText());
    ...
    private void uploadSn(String data) {
        ...
        AsyncHttpUtil.post("/api/T3/storage/stock", params, new AsyncHttpRespHandler(this, true) {
