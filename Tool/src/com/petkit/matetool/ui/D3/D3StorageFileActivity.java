 ...
 */
public class D3StorageFileActivity extends BaseActivity {
    ...
    protected void setupViews() {
        ...
        mUploadTextView.setOnClickListener(D3StorageFileActivity.this);
    ...
    private void uploadFile(String filename) {
        ...
        AsyncHttpUtil.post("/api/d3/batch/file", params, params2, new AsyncHttpRespHandler(this, true) {
