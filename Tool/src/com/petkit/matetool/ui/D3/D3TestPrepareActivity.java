...
import static com.petkit.matetool.ui.D3.utils.D3Utils.FILE_CHECK_INFO_NAME;
import static com.petkit.matetool.ui.D3.utils.D3Utils.FILE_MAINTAIN_INFO_NAME;


/**
 * D3测试，测试准备，需要登录，已经缓存数据处理
 *
 * Created by Jone on 17/4/19.
 */
public class D3TestPrepareActivity extends BaseActivity {
...
//        mTester.setStation("1");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.logout:
                ...
                } else if(D3Utils.checkHasSnCache()) {
            ...
            case R.id.upload:
                if(mDevicesError != null) {
                    ...
                    startActivityWithData(D3ErrorListActivity.class, bundle, false);
                } else {
                    LoadDialog.show(this);
                    startUploadSn();
                }
    ...
    private void updateView () {
        if(mTester != null) {
            ...
            if(mDevicesError != null) {
                ...
                File dir = new File(D3Utils.getD3StoryDir());
    ...
    private void startTest() {
        Bundle bundle = new Bundle();
        bundle.putSerializable(D3Utils.EXTRA_D3_TESTER, mTester);
        startActivityWithData(D3StartActivity.class, bundle, false);
    }
                ...
                if(dataObj != null) {
                    try {
                        ...
                        if(Math.abs(System.currentTimeMillis() - timestamp) < 60 * 60 * 1000) {
                            ...
                            TesterManagerUtils.addTesterForType(Globals.D3, mTester);
    ...
    private void getLastSN() {
        AsyncHttpUtil.get("/api/d3/latest", new AsyncHttpRespHandler(this) {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    if(jsonObject.getInt("code") == 0 && dataObj != null && !dataObj.isNull("sn")) {
                        ...
                        D3Utils.initSnSerializableNumber(sn);
                    }
    ...
    private void loginFailed() {
        ...
        TesterManagerUtils.removeTesterForType(Globals.D3);
        mTester = null;
        updateView();
    }
    ...
    private void uploadSn(final File file) {
        ...
        if(FILE_MAINTAIN_INFO_NAME.equals(file.getName())) {
            api = "/api/d3/maintain/repair";
        } else if(FILE_CHECK_INFO_NAME.equals(file.getName())) {
            api = "/api/d3/maintain/inspect";
        } else {
            api = "/api/d3/batch";
        }
