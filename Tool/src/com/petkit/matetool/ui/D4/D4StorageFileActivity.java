 ...
 */
public class D4StorageFileActivity extends BaseActivity {
    ...
    protected void setupViews() {
        ...
        mUploadTextView.setOnClickListener(D4StorageFileActivity.this);
    ...
    private void uploadFile(String filename) {
        ...
        AsyncHttpUtil.post("/api/d4/batch/file", params, params2, new AsyncHttpRespHandler(this, true) {
