 ...
 */
public class P3StorageFileActivity extends BaseActivity {
    ...
    protected void setupViews() {
        ...
        mUploadTextView.setOnClickListener(P3StorageFileActivity.this);
    ...
    private void uploadFile(String filename) {
        ...
        AsyncHttpUtil.post("/api/P3/batch/file", params, params2, new AsyncHttpRespHandler(this, true) {
