...
import static com.petkit.matetool.utils.Globals.DEVICE_TYPE_CODE_NEW_D2;
...
public class FeederMiniUtils {
    ...
    public static ArrayList<FeederMiniTestUnit> generateFeederMiniTestUnitsForType(int type) {
        ...
        if(type == TYPE_DUPLICATE_MAC) {
            ...
            results.add(new FeederMiniTestUnit(FeederMiniTestModes.TEST_MODE_RESET_SN, "重写SN", 12, 2));
    ...
    public static String generateSNForTester(Tester tester) {
        ...
        return DeviceCommonUtils.generateSN("0" + tester.getStation() + day, DEVICE_TYPE_CODE_NEW_D2, serializableNumber);
    }
