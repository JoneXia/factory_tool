 ...
 */
public class FeederMiniStorageFileActivity extends BaseActivity {
    ...
    protected void setupViews() {
        ...
        mUploadTextView.setOnClickListener(FeederMiniStorageFileActivity.this);
    ...
    private void uploadFile(String filename) {
        ...
        AsyncHttpUtil.post("/api/feedermini/batch/file", params, params2, new AsyncHttpRespHandler(this, true) {
