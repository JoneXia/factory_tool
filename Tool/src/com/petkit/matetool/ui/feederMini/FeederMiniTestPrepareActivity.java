...
import static com.petkit.matetool.ui.feederMini.utils.FeederMiniUtils.FILE_CHECK_INFO_NAME;
import static com.petkit.matetool.ui.feederMini.utils.FeederMiniUtils.FILE_MAINTAIN_INFO_NAME;


/**
 * 喂食器Mini测试，测试准备，需要登录，已经缓存数据处理
 *
 * Created by Jone on 17/4/19.
 */
public class FeederMiniTestPrepareActivity extends BaseActivity {
    ...
    protected void setupViews() {
        ...
        mTester = TesterManagerUtils.getCurrentTesterForType(Globals.FEEDER_MINI);
        if (mTester != null) {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.login:
                if(mTester != null) {
                    if (FeederMiniUtils.checkHasSnCache()) {
            ...
            case R.id.logout:
                ...
                } else if(FeederMiniUtils.checkHasSnCache()) {
            ...
            case R.id.upload:
                if(mFeedersError != null) {
                    ...
                    startActivityWithData(FeederMiniErrorListActivity.class, bundle, false);
                } else {
                    LoadDialog.show(this);
                    startUploadSn();
                }
    ...
    private void startTest() {
        Bundle bundle = new Bundle();
        bundle.putSerializable(FeederMiniUtils.EXTRA_FEEDER_MINI_TESTER, mTester);
        startActivityWithData(FeederMiniStartActivity.class, bundle, false);
    }
                ...
                if(dataObj != null) {
                    try {
                        ...
                        if(Math.abs(System.currentTimeMillis() - timestamp) < 60 * 60 * 1000) {
                            ...
                            TesterManagerUtils.addTesterForType(Globals.FEEDER_MINI, mTester);
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    if(jsonObject.getInt("code") == 0 && dataObj != null && !dataObj.isNull("sn")) {
                        ...
                        FeederMiniUtils.initSnSerializableNumber(sn);
                    }
    ...
    private void loginFailed() {
        ...
        TesterManagerUtils.removeTesterForType(Globals.FEEDER_MINI);
        mTester = null;
        updateView();
    }
