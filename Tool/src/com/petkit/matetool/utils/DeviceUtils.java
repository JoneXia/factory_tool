...
public class DeviceUtils {
    ...
    /**
     * 获取当前语言，优先使用设置的，未设置则取系统的
     *
     * @return
     */
    public static Locale getLanguageLocale(Context context) {

        String localeString = DataHelper.getStringSF(context, Consts.SHARED_SETTING_LANGUAGE);
