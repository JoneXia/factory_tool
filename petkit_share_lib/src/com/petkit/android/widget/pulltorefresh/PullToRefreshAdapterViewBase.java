...
import com.petkit.android.widget.pulltorefresh.internal.EmptyViewMethodAccessor;
import com.petkit.android.widget.pulltorefresh.internal.IndicatorLayout;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	...
	protected void handleStyledAttributes(TypedArray a) {
		...
		int resId = MResource.getResourceIdByName(getContext().getPackageName(), "styleable", "PullToRefresh_ptrShowIndicator");
		mShowIndicator = a.getBoolean(resId, !isPullToRefreshOverScrollEnabled());
	}
	...
	private void addIndicatorViews() {
		...
		if (mode.showHeaderLoadingLayout() && null == mIndicatorIvTop) {
			...
			int resId = MResource.getResourceIdByName(getContext().getPackageName(), "dimen", "indicator_right_padding");
			params.rightMargin = getResources().getDimensionPixelSize(resId);
